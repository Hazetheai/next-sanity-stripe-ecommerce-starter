...
interface TriContentProps {}

const TriContent: React.FC<TriContentProps> = ({}) => {
  return (
    <section className="text-gray-400  body-font container px-5 py-24 mx-auto">
      ...
      <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
        <div className="p-4 md:w-1/3 flex">
          <div className="w-12 h-12 inline-flex items-center justify-center -full bg-gray-800 text-indigo-400 mb-4 flex-shrink-0">
            <svg
              fill="none"
              stroke="currentColor"
              strokeLinecap="round"
